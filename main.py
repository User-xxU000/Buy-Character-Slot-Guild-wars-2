...
st.set_page_config(page_title="Buy - Character Slot ")


st.title("""Offert Chatacters Slot""")
#layouts

col1,col2,col3 = st.columns(3)
with col3:
    st.subheader("""Characters Slot Special Offer""",)
...
with col3:
    st.markdown("""
                ...
                Object Name : Character Slot Expansion

                
                Product Type : Game object
